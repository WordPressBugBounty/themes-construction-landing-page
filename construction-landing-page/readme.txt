...
All images are under Creative Commons Public Domain deed CC0.
    ...
    Source 		: https://pxhere.com/en/photo/117434

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/878831

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/824644

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/756729

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/903240

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/755423
    ...
    Source 		: https://www.flickr.com/photos/136285573@N06/25960012991

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://creativecommons.org/publicdomain/zero/1.0/
    Source 		: https://www.flickr.com/photos/72704623@N02/13959034081
...
== Change Log ==
    ...
    * Fix: Minor refinements have been done in the dashboard links.
    ...
    1.3.8 - March 28, 2024
    * Update: Fontawesome library has been updated supporting new Twitter logo
    
    1.3.7 - Feb 8, 2024
    * Update: Admin ajax request fixed.

    1.3.6 - January 31, 2024
    * Update: Added nonce to the custom admin notice to avoid CSRF vulnerability.

    1.3.5
    * Fix: Menu gap increased in navigation
    * Fix: Warning shown by Perfect Scrollbar package in console is fixed
    * Fix: Minified CSS files

    1.3.4
    * Fix: Console warning issues fixed

    1.3.3
    * Fix : Fixed double h1 tag issue in 404 page for SEO.
    * Fix : Minor Bug Fixes.

    1.3.2
    * Added : Compatiblity Theme styling settings added for modern and classic design.
    * Fixed : Style refinements.
    ...
    * Fixed: Fixed the design of default WP blocks.
    ...
    1.3.0
    * Fixed design issue with archive page description
